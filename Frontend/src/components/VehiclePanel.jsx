  ...
  return (
    <div>
      <div className="flex justify-between pt-2">
        ...
        <h3
          onClick={() => {
            porps.setVehiclePanelOpne(false);
          }}
      ...
      <div
        onClick={() => {
          porps.setConfirmRidePanel(true), porps.selectVehicle("car");
        }}
        className="flex items-center border-2 mb-2 bg-gray-50 active:border-black rounded-xl p-3 justify-between"
      >
        <img
          className="h-10"
      ...
      <div
        onClick={() => {
          porps.setConfirmRidePanel(true), porps.selectVehicle("moto");
        }}
        className="flex items-center border-2 mb-2 bg-gray-50 active:border-black rounded-xl p-3 justify-between"
      >
        <img
      ...
      <div
        onClick={() => {
          porps.setConfirmRidePanel(true), porps.selectVehicle("auto");
        }}
        className="flex items-center border-2 mb-2 bg-gray-50 active:border-black rounded-xl p-3 justify-between"
      >
        <img
