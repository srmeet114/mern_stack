...
const VehiclePanel = (porps) => {
  return (
    <div>
      ...
      <div onClick={()=>{porps.setConfirmRidePanel(true)}} className="flex items-center border-2 mb-2 bg-gray-50 active:border-black rounded-xl p-3 justify-between">
        <img
          className="h-10"
      ...
      <div onClick={()=>{porps.setConfirmRidePanel(true)}} className="flex items-center border-2 mb-2 bg-gray-50 active:border-black rounded-xl p-3 justify-between">
        ...
        <h2 className="text-lg font-semibold">118.32</h2>
      </div>
    </div>
  );
};
